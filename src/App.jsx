    ...
    <div className="bg-gray-100 h-full" id="content">
      ...
      <div className="flex flex-wrap h-full">
        ...
        <div className="w-3/5 p-2">
          <Experience>
            <ExperienceBody title="Lead Full-Stack Developer" company="Syrahealth" date="Jan 2021 - Present" location="Carmel, Indiana, United States - Remote" description="Drove innovation and efficiency in machine learning applications.">
            ...
            <ExperienceBody title="Full Stack Developer" company="Radcube" date="May 2019 - Dec 2020" location="Fully remote" description="Accelerated AI adoption and enhanced SaaS cloud services.">
            ...
            <ExperienceBody title="Web Developer" company="shopknights" date="Jun 2016 - Dec 2017" location="Austin, Texas" description="Enhanced e-commerce capabilities and contributed to open-source projects.">
            ...
            <ExperienceBody title="Assistant to Financial Manager" company="Keller Williams" date="Jan 2015 - May 2016" location="Austin, Texas" description="Streamlined data management for the accounting team.">
