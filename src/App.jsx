      ...
      <div className="flex flex-wrap h-full">
        ...
        <div className="w-3/5 p-2">
          <Experience>
            ...
            <ExperienceBody title="Lead AI Developer" company="Syrahealth" date="Jan 2021 - Present" location="New York, NY" description="Drove innovation and efficiency in machine learning applications.">
            ...
            <ExperienceBody title="Senior Software Engineer" company="Radcube" date="May 2019 - Dec 2020" location="San Francisco, CA" description="Accelerated AI adoption and enhanced SaaS cloud services.">
            ...
            <ExperienceBody title="CTO & Co-Founder" company="OperatorAI" date="Jan 2018 - Apr 2019" location="Boston, MA" description="Optimized global deployment and spearheaded ML automation initiatives.">
            ...
            <ExperienceBody title="Full Stack Developer" company="shopknights" date="Jun 2016 - Dec 2017" location="Los Angeles, CA" description="Enhanced e-commerce capabilities and contributed to open-source projects.">
            ...
            <ExperienceBody title="Data Analyst Intern" company="Keller Williams" date="Jan 2015 - May 2016" location="Houston, TX" description="Streamlined data management for the accounting team.">
