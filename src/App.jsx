    ...
    <div className="bg-gray-100 h-full">
      <div className="flex flex-wrap h-full">
        ...
        <div className="w-3/5 p-2">
          <Experience>
            <ExperienceBody title="Lead AI Developer" company="Syrahealth" date="Jan 2021 - Present" location="New York, NY">
            ...
            <ExperienceBody title="Senior Software Engineer" company="Radcube" date="May 2019 - Dec 2020" location="San Francisco, CA">
            ...
            <ExperienceBody title="CTO & Co-Founder" company="OperatorAI" date="Jan 2018 - Apr 2019" location="Boston, MA">
            ...
            <ExperienceBody title="Full Stack Developer" company="shopknights" date="Jun 2016 - Dec 2017" location="Los Angeles, CA">
            ...
            <ExperienceBody title="Data Analyst Intern" company="Keller Williams" date="Jan 2015 - May 2016" location="Houston, TX">
